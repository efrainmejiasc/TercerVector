...
namespace TercerVector
{
    public class EngineData
    {
        ...
        public static string SQLRuta = "INSERT INTO Ruta (Campo1,Campo2,Campo3,Campo4,Campo5,Campo6,Resultado) VALUES (@Campo1,@Campo2,@Campo3,@Campo4,@Campo5,@Campo6,Resultado)";
        public static string SQLRutas = "SELECT * FROM Ruta";
